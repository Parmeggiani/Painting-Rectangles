...
public class Implementation {
    ...
    private void decreaseArea(int index, int x1, int y1, int x2, int y2){
        int newArea = areas.get(index);
        int areaAux = calculateArea(x1,y1, x2, y2);
        newArea = newArea - areaAux;
        areas.set(index, newArea);
    }

    public void addArea(){
        int x1, y1, x2, y2; int areaAux;
    ...
    public void printColors(){
        int verdeC=0, vermelho=0, azulC=0, amarelo=0, verdeE=0, marrom=0,
